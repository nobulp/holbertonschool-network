...
You press Enter
      │
      ▼
DNS lookup  →  IP address resolved
      │
      ▼
TCP 3-way handshake on port 443
      │
      ▼
...
Load balancer  →  selects a healthy backend server
      │
      ▼
Web server  →  parses HTTP request, routes to app layer
      │
      ▼
...
From the moment you press Enter to the moment the page appears, all of this happens in **under 300 milliseconds** — often much less. It is one of the most impressive feats of distributed engineering in human history, and it happens billions of times a day without most people ever thinking about it.
